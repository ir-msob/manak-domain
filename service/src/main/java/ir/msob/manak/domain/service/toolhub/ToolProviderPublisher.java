...
public class ToolProviderPublisher {
    ...
    private final ToolProviderHandler toolProviderHandler;
    ...
    public void send() {
        ...
        try {
            ...
            // -------------------------------
            SortedSet<ToolDescriptor> tools = handlers.stream()
            ...
            // Build ToolProvider
            // -------------------------------
            ToolProviderDto provider = toolProviderHandler.getToolProvider();
