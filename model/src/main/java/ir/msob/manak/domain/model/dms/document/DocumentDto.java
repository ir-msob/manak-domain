...
public class DocumentDto extends Document implements Dto {
    ...
    @Builder
    public DocumentDto(String name, String key, String description, SortedSet<String> tags, DocumentSpecification specification, SortedSet<Attachment> attachments, SortedSet<Characteristic> characteristics, SortedSet<ObjectValidation> objectValidations, SortedSet<RelatedAction> relatedActions, SortedSet<RelatedDomain> relatedDomains) {
        super(name, key, description, tags, specification, attachments, characteristics, objectValidations, relatedActions, relatedDomains);
    }
}