...
public class GitSpecification extends DomainAbstract {
    ...
    @Transient
    public static final String DOMAIN_NAME_WITH_HYPHEN = "git-specification";
    @Serial
    private static final long serialVersionUID = -8938843864637313000L;
    @NotBlank
    private String name;
    ...
    public GitSpecification(String id, String name, String description) {
        super(id);
        this.name = name;
